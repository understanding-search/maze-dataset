import numpy as np
import pytest
from maze_dataset import SolvedMaze, Coord, CoordArray
...
_MANUAL_EXAMPLES: dict[str, dict[str, SolvedMaze|list[int]|CoordArray]] = {
	'small_5x5' : dict(
		...
		follow_coords = [[0, 3], [1, 2], [2, 1], [2, 0], [3, 0], [4, 0], [4, 1], [4, 2], [4, 3], [4, 4], [3, 4], [2, 4], [2, 3]],
	),
    'medium_10x10': dict(
        maze=SolvedMaze.from_ascii("""
			#####################
		...
		follow_idxs = [ 1,  2,  3,  4,  5,  6,  8,  9, 10, 12, 13, 15, 16, 17, 19, 20, 21,
		22, 23, 25, 26, 27, 29, 30, 31, 33],
		follow_coords = [[8, 0], [9, 0], [9, 1], [8, 1], [8, 2], [9, 2], [8, 3], [8, 4], [8, 5], [8, 7], [9, 7], [8, 8], [8, 9], [7, 9], [6, 8], [7, 8], [7, 7], [6, 7], [6, 6], [7, 5], [7, 4], [7, 3], [6, 2], [6, 1], [6, 0], [4, 0]],
	),
}
