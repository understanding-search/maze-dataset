...
from maze_dataset.tokenization.token_utils import get_tokens_up_to_path_start, tokens_between, get_adj_list_tokens, get_path_tokens, get_origin_tokens, get_target_tokens, strings_to_coords, coords_to_strings, _coord_to_strings_UT, _coord_to_strings_indexed
...
def test_tokens_between():
    ...
    assert tokens_between(tokens, start_value, end_value, True, True) == ["quick", "brown", "fox", "jumps", "over"]
    ...
    assert tokens_between(tokens, "the", "dog", False, False, False) == ["quick", "brown", "fox", "jumps", "over", "the", "lazy"]
...
def test_get_tokens_up_to_path_start_excluding_start():
    result = get_tokens_up_to_path_start(
...
def test_coords_to_strings():
    ...
    skipped = coords_to_strings(coords, coord_to_strings_func=_coord_to_strings_UT, when_noncoord="skip")
    included = coords_to_strings(coords, coord_to_strings_func=_coord_to_strings_UT, when_noncoord="include")
    ...
    with pytest.raises(ValueError):
        coords_to_strings(coords, coord_to_strings_func=_coord_to_strings_UT, when_noncoord="except")
