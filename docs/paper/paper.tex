...
Representational Flexibility},
    pdfauthor={Michael Igorevich Ivanitskiy, Aaron Sandoval, Alexander
F. Spies, Tilman Räuker, Brandon Knutson, Cecilia Diniz Behn, Samy Wu
Fung},
...
Aaron Sandoval, Alexander F. Spies, Tilman Räuker, Brandon Knutson,
Cecilia Diniz Behn, Samy Wu Fung},
...
streamline the process of generating and working with datasets of mazes
that can be described as subgraphs of an \(n \times n\) lattice with
boolean connections and, optionally, start and end points that are nodes
in the graph. Furthermore, we place emphasis on a wide variety of
possible text output formats aimed at evaluating the spatial reasoning
capabilities of Large Language Models (LLMs) and other text-based
transformer models.
...
\item
  ...
  \item
    ...
    (\citeproc{ref-eval-gpt-visual}{2023}) and Oppenheim
    (\citeproc{ref-gh-oppenheimj2018maze}{2018})
  \item
    ...
    outputs of many packages (\citeproc{ref-mazegenerator-net}{Alance
    AB, 2019}; \citeproc{ref-gh_Ehsan_2022}{Ehsan, 2022};
...
\item
  ...
  is similar to that of Liu \& Wu (\citeproc{ref-eval-LLM-graphs}{2023})
...
objects, which have path information and an array optimized for storing
...
replicate the format of Schwarzschild, Borgnia, Gupta, Bansal, et al.
(\citeproc{ref-easy_to_hard}{2021}) and provide the
\href{https://understanding-search.github.io/maze-dataset/maze_dataset/dataset/rasterized.html\#RasterizedMazeDataset}{\texttt{RasterizedMazeDataset}}
...
\texttt{maze-transformer} project
(\citeproc{ref-maze-transformer-github}{Michael I. Ivanitskiy et al.,
2023b}), which aims to investigate spatial planning and world models in
autoregressive transformer models trained on mazes
...
constrained output format of Schwarzschild, Borgnia, Gupta, Bansal, et
al. (\citeproc{ref-easy_to_hard}{2021}). Ongoing work using
...
\begin{itemize}
\item
  By Nolte et al. (\citeproc{ref-nolte2024multistep}{2024}) to compare
...
\item
  By Wang et al. (\citeproc{ref-wang2024imperative}{2024}) and Chen et
  al. (\citeproc{ref-chen2024iaimperative}{2024}) to study imperative
  learning.
\item
  By Zhang et al. (\citeproc{ref-zhang2025tscend}{2025a}) to introduce a
  novel framework for reasoning diffusion models.
\item
  By Dao \& Vu (\citeproc{ref-dao2025alphamaze}{2025}) to improve
  spatial reasoning in LLMs with GRPO.
\item
  By Cai et al. (\citeproc{ref-cai2025morse}{2025}) to create a
  multimodal reasoning benchmark, via mazes in videos.
\item
  By Xu et al. (\citeproc{ref-xu2025visual}{2025}) to study visual
  planning in LLMs.
\item
  By Lee et al. (\citeproc{ref-lee2025adaptive}{2025}) to evaluate
  adaptive inference-time scaling with diffusion models on maze
  navigation tasks.
\item
  By Zhang et al. (\citeproc{ref-zhang2025vfscale}{2025b}) to test
