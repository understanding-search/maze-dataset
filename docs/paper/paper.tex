...
\item
  ...
  \item
    ...
    (\protect\hyperlink{ref-easy_to_hard}{Schwarzschild, Borgnia, Gupta,
    Bansal, et al., 2021}) and can be configured to be similar to the
    outputs of Németh (\protect\hyperlink{ref-gh_Nemeth_2019}{2019})
  \item
...
\item
  ...
  Wu, 2023}) but with many more options, detailed in
...
(\protect\hyperlink{ref-Gallant2015Transducers}{Gallant, 2015}) for
efficiently storing valid tokenizers.
...
Our package is implemented in
Python(\protect\hyperlink{ref-python}{Rossum, 1995}), and makes use of
the extensive scientific computing ecosystem, including NumPy
(\protect\hyperlink{ref-numpy}{Harris et al., 2020}) for array
manipulation, plotting tools Waskom
(\protect\hyperlink{ref-seaborn}{2021}), Jupyter notebooks
(\protect\hyperlink{ref-jupyter}{Kluyver et al., 2016}), and PySR
(\protect\hyperlink{ref-pysr}{Cranmer, 2023}) for symbolic regression.
...
\leavevmode\vadjust pre{\hypertarget{ref-Gallant2015Transducers}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-seaborn}{}}%
