...
(\protect\hyperlink{ref-interpretability-survey}{Räuker et al., 2023}).
...
\item
  ...
  \tightlist
  \item
    \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset/dataset/rasterized.html#RasterizedMazeDataset}{\texttt{RasterizedMazeDataset}}}{RasterizedMazeDataset},
    utilizing
    \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset.html#LatticeMaze.as_pixels}{\texttt{as\_pixels()}}}{as\_pixels()},
  ...
  \item
    \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset.html#LatticeMaze.as_ascii}{\texttt{as\_ascii()}}}{as\_ascii()}
  ...
  \item
    \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset/plotting.html#MazePlot}{\texttt{MazePlot}}}{MazePlot}
...
\item
  ...
  \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset.html#MazeDataset.as_tokens}{\texttt{SolvedMaze(...).as\_tokens()}}}{SolvedMaze(...).as\_tokens()}
  is similar to that of (\protect\hyperlink{ref-eval-LLM-graphs}{Liu \&
  Wu, 2023}) but with many more options, detailed
  \secref{sec:tokenized-output-formats}.
\item
...
\item
  ...
  detailed in \secref{sec:implementation}.
\item
...
\docslinkcodemain{MazeDatasetConfig} configuration object, which allows
...
\leavevmode\vadjust pre{\hypertarget{ref-interpretability-survey}{}}%
