...
- Most prior works provide mazes in visual or raster formats, and we provide a variety of similar output formats:
  - \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset/dataset/rasterized.html#RasterizedMazeDataset}{\texttt{RasterizedMazeDataset}}}{RasterizedMazeDataset}, utilizing \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset.html#LatticeMaze.as_pixels}{\texttt{as\_pixels()}}}{as\_pixels()}, which can exactly mimic the outputs provided in `easy-to-hard-data` [@easy_to_hard] and can be configured to be similar to the outputs of @gh_Nemeth_2019
  - \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset.html#LatticeMaze.as_ascii}{\texttt{as\_ascii()}}}{as\_ascii()} provides a format similar to [@eval-gpt-visual; @gh-oppenheimj2018maze]
  - \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset/plotting.html#MazePlot}{\texttt{MazePlot}}}{MazePlot} provides a feature-rich plotting utility with support for multiple paths, heatmaps over positions, and more. This is similar to the outputs of [@mdl-suite; @mathematica-maze; @mazegenerator-net; @gh_Ehsan_2022]


- The text format provided by \texorpdfstring{\href{https://understanding-search.github.io/maze-dataset/maze_dataset.html#MazeDataset.as_tokens}{\texttt{SolvedMaze(...).as\_tokens()}}}{SolvedMaze(...).as\_tokens()} is similar to that of [@eval-LLM-graphs] but with many more options, detailed \secref{sec:tokenized-output-formats}.
...
- Storing mazes as images or adjacency matrices is not only difficult to work with, but also inefficient. We use a highly efficient method detailed in \secref{sec:implementation}.
