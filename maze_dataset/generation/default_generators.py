...
DEFAULT_GENERATORS: list[tuple[str, dict]] = [
    ...
    # ("gen_dfs", dict(n_accessible_cells=0.8)),
    # ("gen_dfs", dict(max_tree_depth=0.5)),
    # ("gen_dfs", dict(n_accessible_cells=0.5, max_tree_depth=0.5)),
    ("gen_wilson", dict()),
    # ("gen_percolation", dict(p=0.1)),
    ("gen_percolation", dict(p=0.4)),
    ("gen_dfs_percolation", dict(p=0.1)),
    ("gen_dfs_percolation", dict(p=0.4)),
    ("gen_prim", dict()),
	("gen_prim", dict(do_forks=False)),
    # ("gen_prim", dict(n_accessible_cells=0.5)),
    # ("gen_prim", dict(max_tree_depth=0.5)),
    # ("gen_prim", dict(n_accessible_cells=0.5, max_tree_depth=0.5)),
    ("gen_hallway", dict()),
]
